...
def test_sign_up(client):
    res=client.post(
      "/api/v1/users/register/" , json={"first_name": "Slightly", "last_name": "Techie", "email": "slightlytechie@gmail.com", "password": "food", "password_confirmation": "food", "yoe": 5, "bio": "I am almost a techie", "phone_number": "233567895423", "is_active": True}
    )
