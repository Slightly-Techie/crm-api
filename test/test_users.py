...
def test_sign_up(client):
    res=client.post(
      "/api/v1/users/register/" , json={"username": "slightlytechie1","first_name": "Slightly", "last_name": "Techie", "email": "slightlytechie@gmail.com", "password": "food1234", "password_confirmation": "food1234", "years_of_experience": 5, "bio": "I am almost a techie", "phone_number": "233567895423", "is_active": True}
    )
...
def test_incorrect_log_in(client, email, password, status_code):
    data = {k: v for k, v in {"username": email, "password": password}.items() if v is not None}
